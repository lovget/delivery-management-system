...
export default function ProductsPage({ onError, onSuccess }) {
    ...
    return <div>
        ...
        {loading ? <div className="card empty-state">Loading products...</div> : <table className="table"><thead><tr><th>Name</th><th>Price</th><th>Categories</th><th>Actions</th></tr></thead><tbody>
